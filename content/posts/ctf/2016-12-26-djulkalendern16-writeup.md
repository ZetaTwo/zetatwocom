...
The seed gives us the number $0.633603952323$ but that number does not exist in the passwords file.
...
Thus you can calculate a number in the interval $[1-100]$ that eventually reaches 1456.
